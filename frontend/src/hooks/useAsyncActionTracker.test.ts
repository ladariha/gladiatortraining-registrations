...
describe("useAsyncActionTracker", () => {
  ...
  describe("initial state", () => {
    ...
    it("should initialize with provided initial state", () => {
      ...
      const { result } = renderHook(() => useAsyncActionTracker(mockAction, initialData, false, true));
  ...
  describe("error handling", () => {
    ...
    it("should clear previous data on error", async () => {
      const mockAction: AsyncAction<void, string> = jest.fn().mockResolvedValueOnce("success").mockRejectedValueOnce(new Error("fail"));
  ...
  describe("suppress loading indicator", () => {
    ...
    it("should show loading when suppress is true but there was a previous error", async () => {
      const mockAction: AsyncAction<void, string> = jest
        .fn()
